...
<section class="container-fluid m-0">
    <div class="row d-flex justify-content-center">
        <div id="letter_download_container"
            class="p-5 col-md-6 d-flex flex-column justify-content-center text-light">
            <h2 class="fw-bold text-start">PRO Letter Download</h2>
            <p>लैटर डाउनलोड करने के लिए अपना रजिस्टर्ड मोबाइल नंबर एवं जन्म दिनांक प्रविष्ट करे</p>
        </div>
        <div class="p-5 col-md-6">
            <form class="p-5">
                ...
                <button type="submit" class="btn btn-dark d-flex align-items-start mb-3">Download PRO Letter</button>
            </form>
        </div>
    </div>
</section>
